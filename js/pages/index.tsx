  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Extend - The Most Customizable NFT"
        />
        <meta
          property="og:description"
          content="Extend your world with Spaces"
        />
        <meta
          property="og:image"
        ...
        <Row>
          ...
          <Col xs={24} sm={24} md={12} lg={12} xl={13}>
            <Row className={styles.launchAppContainer}>
              ...
              <a href="https://canvas.extend.xyz/">
      ...
      <section className={`${styles.sectionHeader}`}>
        <Row>
          <Col
            ...
            lg={12}
            xl={11}
            className={styles.headerSectionContent}
          >
            ...
            <div>
              ...
              <p className={styles.headerText}>
                A million Spaces will be minted for FREE on the blazing fast
                Solana network, the largest NFT mint to date. Mint a single
                Space or collect a whole Neighborhood right from the canvas.
              ...
              <a href="https://canvas.extend.xyz/mint">
                <Button
                  className={`big-button ${styles.borderRadiusButton}`}
                  size={"middle"}
                >
                  Mint your Space now
                </Button>
      ...
      <section className={`${styles.sectionMain} `}>
        <Row className={styles.sectionReverse}>
          <Col
            className={styles.spaceImageContainer}
            sm={24}
            md={11}
            lg={11}
            xl={10}
          ...
          <Col
            ...
            lg={13}
            xl={11}
            className={`${styles.sectionContent} ${styles.spaceContent}`}
          >
            <h1>Become a Neighbor</h1>
            <p>
              Spaces are programmable. To start each Space gives the Space owner
              the ability to modify the color of a single pixel on our 1000 x
              1000 Canvas. Imagine what’s possible with a little coordination!
            </p>
            <div>
              <a href="https://canvas.extend.xyz">
                <Button className={styles.borderRadiusButton} size={"middle"}>
                  Browse the Canvas
                </Button>
              </a>
            </div>
      ...
      <section className={`${styles.sectionHeader}`}>
        <Row>
          ...
          >
            ...
            <p>
              {/* Spaces are programmable. To start, each Space can be registered on our 1000 x 1000 Canvas
                            ...
                            <br/>
                            <br/> */}
              Buy and Sell pixels on our canvas. Look for opportunities to
          ...
          <Col
            ...
            lg={10}
            xl={13}
            className={styles.extendsImageContainer}
          ></Col>
        </Row>
      </section>
      ...
      <section className={`${styles.sectionMain} `}>
        <Row className={styles.sectionReverse}>
          <Col
            className={styles.arrowImageContainer}
            sm={24}
            md={11}
            lg={11}
            xl={10}
          ...
          >
            ...
            <p>
              {/* Spaces are programmable. To start, each Space can be registered on our 1000 x 1000 Canvas
                            ...
                            <br/>
                            <br/> */}
              Extend is open to developers and new experiences will continue to
              be added. Each Space is minted with an X and Y coordinate. The Z
              is left to you, the creators.
            </p>
          </Col>
        </Row>
      </section>
      <section className={`${styles.sectionMain} ${styles.sectionNotMargin}`}>
        <Row justify={"center"}>
          <Col md={24} className={styles.extendSection}>
            ...
            <a href="https://canvas.extend.xyz">
              <Button
                className={`${styles.borderRadiusButton} ${styles.browseTheMapButton}`}
              >
                Browse the Canvas
              </Button>
            </a>
          ...
          <Col sm={24} md={16} className={styles.roadMapContent}>
            ...
            <Accordion flush>
              ...
              <Accordion.Item eventKey="2" className={styles.accordionItem}>
                <Accordion.Header>
                  What? Why is there a captcha?
                </Accordion.Header>
                <Accordion.Body style={{ backgroundColor: "black" }}>
                  We do not believe users with bots are entitled to unlimited
                  minting. The captcha prevents botting and is our “proof of
                  human work.”
                </Accordion.Body>
              </Accordion.Item>
            ...
            <Accordion flush>
              <Accordion.Item eventKey="0" className={styles.accordionItem}>
                <Accordion.Header>
                  Why can’t I change the color of my Space?
                </Accordion.Header>
                <Accordion.Body style={{ backgroundColor: "black" }}>
            ...
            <Accordion flush>
              <Accordion.Item eventKey="0" className={styles.accordionItem}>
                ...
                <Accordion.Body style={{ backgroundColor: "black" }}>
                  Extend is building the next generation of NFT, Spaces. Each
                  Space represents ownership of coordinates (x,y) which can be
                  extended to participate in new application layers. The Canvas
              ...
              <Accordion.Item eventKey="1" className={styles.accordionItem}>
                ...
                <Accordion.Body style={{ backgroundColor: "black" }}>
                  - Buy SOL: available on Coinbase, FTX, etc... <br />- Transfer
                  / withdraw SOL to your Phantom Wallet to interact with the
                  website.{" "}
                  <a href="https://phantom.app/help/installing-phantom">
                    How to setup a Phantom wallet
                  </a>
                  <br />- Follow the mint instructions under “How do I mint a
                  Space?”.
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="2" className={styles.accordionItem}>
                ...
                <Accordion.Body style={{ backgroundColor: "black" }}>
                  Solana is the most efficient blockchain available right now. A
                  project of this magnitude would be prohibitively expensive on
                  Ethereum.
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="3" className={styles.accordionItem}>
                <Accordion.Header>
                  1 million NFTs? Aren’t you killing the environment?
                </Accordion.Header>
                <Accordion.Body style={{ backgroundColor: "black" }}>
                  Based on the{" "}
                  <a href="https://solana.com/news/solana-energy-usage-report-november-2021">
                    most recent (Nov 2021) energy usage report
                  </a>{" "}
                  on Solana, each transaction uses 1,837 J, which is less than
                  the energy usage of two Google searches and 0.000265 percent
                  of the equivalent cost for an Ethereum transaction. To put
                  that into perspective, minting one million Spaces uses less
                  energy than minting an Ethereum collection of size 3.
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="4" className={styles.accordionItem}>
                <Accordion.Header>Wen decentralized?</Accordion.Header>
                <Accordion.Body style={{ backgroundColor: "black" }}>
                  - Actions taken on the website send transactions directly to
                  the blockchain.
                  <br />
                  - When you connect to our website, your browser reads the
              ...
              <Accordion.Item eventKey="6" className={styles.accordionItem}>
                <Accordion.Header>
                  What’s the creator (royalty) fee?
                </Accordion.Header>
                <Accordion.Body style={{ backgroundColor: "black" }}>
                  Zero, we are committed to the lowest transaction costs
                  possible and we view you, the Space owners, as the creators.
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="7" className={styles.accordionItem}>
                <Accordion.Header>What’s the marketplace fee?</Accordion.Header>
                <Accordion.Body style={{ backgroundColor: "black" }}>
                  One percent, full proceeds go to the Extend DAO and will be
                  used for future development.
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="8" className={styles.accordionItem}>
                <Accordion.Header>
                  What happens to the convenience fees?
                </Accordion.Header>
                <Accordion.Body style={{ backgroundColor: "black" }}>
      ...
      <section className={`${styles.sectionMain}`}>
        ...
        <Row className={styles.socialMediaBar}>
          {/* <img src={"/images/twitter.svg"} className={styles.socialMediaButton}/> */}
          <a
            href="https://t.me/ExtendOfficial"
          ...
          <a
            href="https://discord.gg/sjdNRwtJDy"
            className={styles.socialMediaButton}
          >
            <img
          ...
          <a
            href="https://twitter.com/ExtendXYZ"
            className={styles.socialMediaButton}
          >
            <img
          ...
          <a
            href="https://www.instagram.com/extendxyz/"
            className={styles.socialMediaButton}
          >
            <img
          ...
          <a
            href="https://github.com/ExtendXYZ/extend-official"
            className={styles.socialMediaButton}
          >
            <img
